...
plt.bar(Spaces,FailurePercentage, width=1.0,align = 'center', edgecolor = 'black', tick_label = ['Without bouquet', 'With bouquet'],capsize = 5, yerr=Failures_Error,color=['Grey', '#055ce6', 'C1'])
